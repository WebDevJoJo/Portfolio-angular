...
export class PreventiveComponent {
  ...
  priceCalculate() {
    const inputs=(<HTMLInputElement[]><unknown>document.getElementsByClassName("form-check-input"));
    ...
    const password=<HTMLInputElement>document.getElementById("floatingPassword");
  ...
  ShowUrl() {
    const switcheck =<HTMLInputElement> document.getElementById("flexSwitchCheckChecked");
  ...
  Check(){
      const url=(<HTMLInputElement><unknown>document.getElementById("basic-url")).value;
